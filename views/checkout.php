...
if(isset($_POST["Chekout"])){
    ...
    VALUES (:total1,:user_id1,:date1,:address1,:phone1,:postal_code1,:city1,:c)";
   ...
   $stmt->bindParam(':c', $_REQUEST['c']);

   
   //  $stmt->execute();
   
   //  header("location:sucsesscheckout.php");
   $stmt->execute();
//    header('Refresh:0');
    ...
    <div class="col-sm-12">
        <div>
            <p class="form-control-wrap your-name">
                ...
                <input type="text" name="address" value="<?php echo $user->first_name." " .$user->last_name?>" size="40"  class="form-control text validates-as-required" style="width:50%" />
            </p>
        </div>
    </div>
    <div class="col-sm-12">

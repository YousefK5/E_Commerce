									...
									<form method="post" action="shop.php">
										<div class="price_slider_wrapper">
											...
											<div class="price_slider_amount">
												<input type="text" id="min_price" name="min_price" value="<?php echo $min_price ?>" data-min="10" placeholder="Min price"/>
								...
								<div class="masonry-filter">
									<div class="filter-action filter-action-center">
										<ul data-filter-key="filter">
											...
											<li>
												<a href="./shop.php" data-filter-value=".mattresses">Mattresses</a>
											</li>
											<li>
												<a href="./shop.php" data-filter-value=".pillows">pillows</a>
											</li>
											<li>
												<a href="./shop.php" data-filter-value=".duvets">Duvets</a>
											</li>
											<li>
												<a href="./shop.php" data-filter-value=".duvetcoverssets">Duvet covers sets</a>
											</li>
											<li>
												<a href="./shop.php" data-filter-value=".sheets">Sheets</a>
											</li>
											<li>
												<a href="./shop.php" data-filter-value=".blankestandthrows">Blankest and throws</a>
											</li>
										</ul>
									</div>
								</div>

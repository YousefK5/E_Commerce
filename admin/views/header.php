  ...
  <body>
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.php"><img src="../../images/ltrblack.png" alt="logo" style="min-height: 60px; min-width:175px;" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.php"><img src="../../images/ltrblackmini.png" alt="logo" style="min-height: 30px; min-width:40px; margin-left: 25px;"/></a>
        </div>
